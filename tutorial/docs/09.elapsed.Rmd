...
The "timing" is a dataframe and contains 6 components. The "timing$compute" is a facor consisting of
two levels "O" and "T". The "timing$p" is the number of independent varibales. The "timing$t" is the
elapsed-time.
