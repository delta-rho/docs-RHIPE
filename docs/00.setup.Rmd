...
So this working directory is on the initiating R server. All files like dataset, results, or plots you created will be transferred between this working directory on the initiating R server and the HDFS on the
