...
The `map1` is the map function and `mr1` is the execution function `rhwatch` we write in the datasets
generation part of the single run example. So the idea is to put the single run code to a loop.
