...
### Install RHIPE and Push Packages ###
...
Each time your R code will require the intallations on the HDFS, you
must in your R session run
```{r eval=FALSE, tidy=FALSE}
library(Rhipe) rhinit()
rhoptions(zips = "/myloginname/bin/MyBin")
