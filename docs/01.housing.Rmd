...
Each column is separated by a tab. And the total size of the data text file is around 12Mb, and text
file is available in our Tesseradata Github repository.   

### Write to HDFS ###

make the data to be text
