...
We calculate the min, median, and max of listing price by county and them we collect all statistics 
of listing price of counties for every state, and create a `data.frame` for each state. 
